...
;--------------------------------
; Custom defines
  !define NAME "Jeu des Allumettes"
  !define APPFILE "Jeu_allumettes_fr.exe"
...
; General
  ...
  Name "${NAME}"
  OutFile "${NAME} Installateur.exe"
  InstallDir "$PROGRAMFILES\${NAME}"
  InstallDirRegKey HKCU "Software\${NAME}" ""
  RequestExecutionLevel admin
  BrandingText "Le Jeu des Allumettes - 2022"
...
; Descriptions
  ...
  ;Language strings
  LangString DESC_DeskShort ${LANG_FRENCH} "Creer un raccourci sur le bureau."
